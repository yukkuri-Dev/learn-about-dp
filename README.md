# CASIO EX-word DATAPLUS 5/6/7 File manager

![](image.jpg)

This repository provides a file manager for CASIO EX-word electronic dictionaries running DATAPLUS 5/6/7.
As the project is still under development, it can currently only access the root of the internal storage.
Features such as moving files, renaming files, and copying files are not yet implemented.

This project is based on [Gnuboy EX](https://github.com/brijohn/gnuboy-ex), which is licensed under the [GPL-2.0](COPYING).
In accordance with its licensing terms, this repository is also licensed under [GPL-2.0](COPYING).
